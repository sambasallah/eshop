...
<div class="about">
	<div class="about_container">
		<div class="row">
			<div class="col-md-3">
				<div class="nav_tab_container_about">	
						<ul class="nav nav-pills flex-column">
		  			<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Company Overview</a></li>
		  			<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#mission_vission">Culture & Values</a></li>
				</ul>
				</div>	
			</div>
			<div class="col-md-9">
				<div class="tab-content">	
					<div class="tab-pane active container about_content" id="about">
					...
					<div class="tab-pane container about_content" id="mission_vission">
						<h3>Our Mission</h3>
